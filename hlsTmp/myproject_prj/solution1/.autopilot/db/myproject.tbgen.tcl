...
set C_modelArgList {
	{ input1 int 256 regular {pointer 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "input1", "interface" : "wire", "bitwidth" : 256, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ input1_ap_vld sc_in sc_logic 1 invld 0 } 
	{ input1 sc_in sc_lv 256 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input1_ap_vld", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "input1", "role": "ap_vld" }} , 
 	{ "name": "input1", "direction": "in", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "input1", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "input1", "Type" : "Vld", "Direction" : "I",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ret1_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_16_6_5_3_0_config2_s_fu_63", "Parent" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ret_relu_ap_fixed_16_6_5_3_0_ap_ufixed_8_0_4_0_0_relu_config4_s_fu_69", "Parent" : "0",
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_ufixed_8_0_4_0_0_ap_fixed_16_6_5_3_0_config5_s_fu_131", "Parent" : "0",
...
set ArgLastReadFirstWriteLatency {
	myproject {
		...
		layer5_out_0 {Type O LastRead -1 FirstWrite 3}
		layer5_out_1 {Type O LastRead -1 FirstWrite 3}
		layer5_out_2 {Type O LastRead -1 FirstWrite 3}}
...
set Spec2ImplPortList { 
	input1 { ap_vld {  { input1_ap_vld in_vld 0 1 }  { input1 in_data 0 256 } } }
