...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.myproject.autotvin_x_profile.dat"
         "c.myproject.autotvin_z_global.dat"
         "c.myproject.autotvin_y_profile.dat"
         "c.myproject.autotvin_y_local.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.myproject.autotvout_layer25_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
